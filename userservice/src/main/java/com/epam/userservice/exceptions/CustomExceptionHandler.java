...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(UserNameDoesNotExists.class)
	public ResponseEntity<ErrorResponse> handleUserNameDoesNotExistsException(UserNameDoesNotExists exception,
			WebRequest request) {
		log.error("User Name does not exists ");
		ErrorResponse errorResponse = new ErrorResponse(new Date(), exception.getMessage(),
				request.getDescription(false));
		return new ResponseEntity<>(errorResponse, HttpStatus.BAD_REQUEST);
	}
	...
	public ResponseEntity<ErrorResponse> handleNullValueException(NullValueException exception, WebRequest request) {
		log.error("User name or password cant be null ");
		ErrorResponse errorResponse = new ErrorResponse(new Date(), exception.getMessage(),
				request.getDescription(false));
		return new ResponseEntity<>(errorResponse, HttpStatus.BAD_REQUEST);
	}
	...
	public ResponseEntity<ErrorResponse> handleInvalidUserNameException(InvalidUserName exception, WebRequest request) {
	...
	public ResponseEntity<ErrorResponse> handleUserAlreadyExists(UserAlreadyExists exception, WebRequest request) {
